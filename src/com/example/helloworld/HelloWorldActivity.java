...
public class HelloWorldActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tabber = (MainTabbarFragment) getFragmentManager().findFragmentById(R.id.frag_tabbar);
		tabber.setOnTabSelectedListener(new OnTabSelectedListener() {
